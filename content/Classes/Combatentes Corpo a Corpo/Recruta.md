O **Recruta** é uma [[Classes|classe]] de combate focada nos **fundamentos do confronto físico**, combinando ataque, defesa e resistência para se adaptar às necessidades do campo de batalha.
...
Classe base focada em combate direto, resistência e presença na linha de frente.
...
Enquanto a postura estiver ativa, recebe:
...
Ao interceptar, o Recruta assume o [[Ataque]] no lugar do aliado.

A partir desse momento, o ataque passa a ser tratado como direcionado ao próprio Recruta.
...
O Recruta precisa ser realmente capaz de alcançar a trajetória do ataque.
...
Enquanto estiver em Postura Defensiva:

- não pode realizar [[Ataque|Ataques]];
- não pode utilizar **Contra-Ataque**;
- precisa conseguir fisicamente realizar cada interceptação;
- ainda precisa pagar normalmente os custos das defesas realizadas;
- continua podendo realizar outras ações que não contradigam a postura.
